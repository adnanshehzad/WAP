...
<head>
  <meta charset="UTF-8">
  <title>CS472-WAP-Lessons 15 and 16: Data Access and WebApp Security</title>
...
<body>
    ...
    <div class="container">
      <div class="jumbotron">
        <h1 class="display-3">Hello, Servlet 4.0, JSP 2.3 and Database!</h1>
        <h3>Welcome to Lessons 15 and 16: Data Access and WebApp Security</h3>
